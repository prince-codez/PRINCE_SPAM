...
from PRINCE.data import ALTRON
...
SUDO_USERS = list(map(lambda x: int(x), getenv("SUDO_USERS", default="7096860602").split()))
for x in ALTRON:
    SUDO_USERS.append(x)
OWNER_ID = int(getenv("OWNER_ID", default="7096860602"))
